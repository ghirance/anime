...
<!-- di ko alam kung mag tuloy tayo dito tsaka bootstrap etc etc -->
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  ...
  <!-- di ko pa sure kung ano lalagay natin eh dinagdagan ko lang  -->
...
<!-- di ko pa rin maayos footer check mo nalang sir -->
  <div id = "footer">
