  ...
  <span id = "fontH">ALL PRODUCTS</span>
    ...
    <div class="row" id = "row1">
      <div class="col-sm"><a href = "#!">
            <img src = "Figures/kimono-1.jpg" class = "mx-auto d-block bg-dark" >
...
<div class = "d-flex justify-content-center" style = "padding-top:30px">
<a href="#" id = "bd">Shop All Products</a>
</div>
<div class = "container">
  <h2></h2>
...
<footer class="bg-light text-white bg-company-red ">
    <div class="container py-5">
        <div class="row " >
            <div class="col-xl-3"><img src="logos.png" height = "60" style= "padding-right:30px"></div>
